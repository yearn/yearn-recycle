...
def test_buy_underlying_and_recycle(recycle, coins, uniswap, weth, yusd, accounts, unlimited):
...
def test_buy_underlying_and_recycle_exact(recycle, coins, uniswap, weth, yusd, accounts):
    buy_coins_on_uniswap(uniswap, coins, accounts[0])
